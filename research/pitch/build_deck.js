...
[["No cameras", MED], ["No database of the poor", SHEL], ["Working demo · 245 tests", GOOD]].forEach(([t, c], i) => {
...
s.addText("Equitech alum. Built the whole system solo — intake pipeline, control room, responder app, 245 automated tests — before asking anyone for a rupee. Every design choice in it cites a real system that came before and failed, for a specific, documented reason.",
...
lede(s, "245 automated tests. Three real surfaces — control room, responder phone, witness phone — running the same loop end to end, offline, with zero paid API calls.", M, 1.95, 11.5, 14);
