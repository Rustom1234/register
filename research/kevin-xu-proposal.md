...
- **Privacy by architecture:** no names or identifiers of street residents; photos deleted at case close; pins expire at 72h; analytics on coarse cells only; witness numbers hashed; contractual bar on sharing with enforcement. In a country that still criminalizes begging, the strongest guarantee is that the sensitive dataset is never created.
